...
def turtle4():
    goofy = rg.SimpleTurtle()
    goofy.pen = rg.Pen('green',20)
...
def turtle5():
    grumpy = rg.SimpleTurtle()
    grumpy.pen = rg.Pen('orange',10)

    grumpy.draw_square(20)

    sleepy = rg.SimpleTurtle()
    sleepy.pen = rg.Pen('pink',20)

    sleepy.draw_circle(10)
